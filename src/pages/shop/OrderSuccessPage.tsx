...
export function OrderSuccessPage() {
  ...
  return (
    <div className="mx-auto max-w-md py-10 text-center">
      <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-[#F5EBE6]">
        <CheckCircle2 className="h-7 w-7 text-[#E86F3D]" />
      </div>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-5 text-left shadow-sm">
        ...
        <p className="text-2xl font-bold text-[#E86F3D]">{formatCurrency(order.totalAchat)}</p>
      ...
      <Button asChild className="mt-6 bg-[#E86F3D] text-white hover:bg-[#D95F2C]">
